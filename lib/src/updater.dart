...
class Updater<T> extends UpdaterOrSpecial {
  ...
  static Map insOfCache = _updatersCache;
  ...
  void dispose() {
    // print('dispose');
    if (_updatersCache.containsKey(toString())) {
      (_updatersCache[toString()] as Updater).initialized = false;
...
class SpecialUpdater<T> extends UpdaterOrSpecial {
  ...
  void dispose() {
    if (_updatersCache.containsKey(updaterSpecialId)) {
      (_updatersCache[updaterSpecialId] as SpecialUpdater).initialized = false;
